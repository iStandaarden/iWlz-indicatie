...
Notificatie aan het zorgkantoor als het CIZ een nieuwe VervallenGeldigheid heeft geregistreerd bij een Wlz-indicatie waarvoor dit zorgkantoor verantwoordelijk is, was of wordt.
...
**De trigger voor de notificatie is:** 
  ...
  > het registreren van VervallenGeldigheid bij een Wlz-indicatie. 
...
opstellen:- NIEUWE_VERVALLENGELDIGHEID_ZORGKANTOOR
  verstuur:Verstuur 
...
| eventType | "NIEUWE_VERVALLENGELDIGHEID_ZORGKANTOOR" | ```"eventType": "NIEUWE_VERVALLENGELDIGHEID_ZORGKANTOOR"``` |
