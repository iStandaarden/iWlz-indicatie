...
- **Nieuwe** **query**-template voor zorgkantoor nieuw verantwoordelijk toegevoegd: ```QIR-0003-ZKn.graphql```. zie [/gql-query/zorgkantoor](/gql-query/zorgkantoor/) inclusief autorisatiebeschrijving.
- **Nieuwe** **query**-template voor zorgkantoor uitvoerend toegevoegd: ```QIR-0004-ZKu.graphql```. zie [/gql-query/zorgkantoor](/gql-query/zorgkantoor/) inclusief autorisatiebeschrijving.

- **Notificaties** opgenomen in Git-repo Indicatieregister. Zie in [notificaties-folder](/notificaties/README.md)
